            ...
            >
              ...
              <div class="p-3 position-relative">
                <div class="list-card-body">
                  <h6 class="mb-1">
                    <a href="checkout.html" class="text-black"
                      >Famous Dave's Bar-B-Que</a
                    >
                  </h6>
        ...
        <div class="col-md-8 pt-3">
          <div class="shadow-sm rounded bg-white mb-3 overflow-hidden">
            ...
            <div class="row m-0">
              ...
              <div class="col-md-12 px-0 border-top">
                <div class>
                  <div
                    class="d-flex align-items-center gap-2 p-3 border-bottom menu-list"
                  >
          ...
          <div class="mb-3">
            ...
            >
              ...
              <hr />
              <a class="text-center w-100 d-block mt-3 fw-bold" href="#"
                >See All Reviews</a
              >
            </div>
            <div
              ...
              <div class="recepie-body">
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    checked
                  />
                  <label class="form-check-label" for="customRadio1f"
                    >Tuna <span class="text-muted">+$35.00</span></label
                  >
                </div>
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    class="form-check-input"
                  />
                  <label class="form-check-label" for="customRadio2f"
                    >Salmon <span class="text-muted">+$20.00</span></label
                  >
                </div>
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    class="form-check-input"
                  />
                  <label class="form-check-label" for="customRadio3f"
                    >Wasabi <span class="text-muted">+$25.00</span></label
                  >
                </div>
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    class="form-check-input"
                  />
                  <label class="form-check-label" for="customRadio4f"
                    >Unagi <span class="text-muted">+$10.00</span></label
                  >
                </div>
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    class="form-check-input"
                  />
                  <label class="form-check-label" for="customRadio5f"
                    >Vegetables <span class="text-muted">+$5.00</span></label
                  >
                </div>
                <div class="form-check custom-radio border-bottom py-2">
                  <input
                    ...
                    class="form-check-input"
                  />
                  <label class="form-check-label" for="customRadio6f"
                    >Noodles <span class="text-muted">+$30.00</span></label
                  >
                </div>
