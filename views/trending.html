...
<html lang="en">
  ...
  <body class="fixed-bottom-bar">
      ...
      <div class="container">
        <div class="most_popular py-5">
          <div class="d-flex align-items-center mb-4">
            <h3 class="fw-bold text-dark mb-0">Trending</h3>
            <a
              href="#"
      ...
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-footer p-0 border-0">
            ...
            <div class="col-6 m-0 p-0">
              <a href="most_popular.html" class="btn btn-primary btn-lg w-100"
                >Apply</a
              >
            </div>
          </div>
    ...
    <script
      type="38ba8bacf5466102d7105d48-text/javascript"
    ...
    <script
      ...
      data-cf-settings="38ba8bacf5466102d7105d48-|49"
      defer
    ></script>
    <script
      defer
      ...
      data-cf-beacon='{"rayId":"8a5eb0d3bb18639d","version":"2024.7.0","r":1,"serverTiming":{"name":{"cfL4":true}},"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}'
