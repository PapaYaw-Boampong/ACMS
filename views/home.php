...
<head>
  ...
  <script type="7cd9e49886f583b445a907f9-text/javascript" src="../vendor/jquery/jquery.min.js"></script>
...
<body class="fixed-bottom-bar">
  ...
  <div class="osahan-home-page">
          ...
          <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
              <div class="list-card-body">
                <h6 class="mb-1">
                  <a href="restaurant.html" class="text-black">Famous Dave's Bar-B-Que
                  </a>
                </h6>
                <p class="text-gray mb-3">Vegetarian • Indian • Pure veg</p>
                <p class="text-gray mb-3 time">
                  <span class="bg-light text-dark rounded-sm py-1 px-2"><i class="feather-clock"></i> 15–30 min</span>
          ...
          <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
              <div class="list-card-body">
                ...
                <p class="text-gray mb-3 time">
                  <span class="bg-light text-dark rounded-sm py-1 px-2"><i class="feather-clock"></i> 30–35 min</span>
        ...
        <div class="osahan-slider-item">
          <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
              <div class="list-card-body">
                <h6 class="mb-1">
                  <a href="restaurant.html" class="text-black">The osahan Restaurant
                  </a>
                </h6>
    ...
    <script type="7cd9e49886f583b445a907f9-text/javascript" src="../vendor/slick/slick/slick.min.js"></script>

    <script type="7cd9e49886f583b445a907f9-text/javascript" src="../vendor/sidebar/hc-offcanvas-nav.js"></script>

    <script type="7cd9e49886f583b445a907f9-text/javascript" src="../js/osahan.js"></script>

    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="7cd9e49886f583b445a907f9-|49" defer></script>
