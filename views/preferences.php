...
<body class="fixed-bottom-bar">
    ...
    <div class="container position-relative">
      <div class="py-5 osahan-profile row">
        <div class="col-md-4 mb-3">
          <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden" id="profile-nav">
          </div>
        </div>
          ...
          <div class="rounded shadow-sm">
            <div class="osahan-cart-item-profile bg-white rounded shadow-sm p-4">
              <div class="flex-column">
                ...
                <form name="preferenceForm" action="../actions/addPreferences.php" method="POST">
                  <div class="form-group mb-3">
                    ...
                    <div>
                      <div class="form-check form-check-inline ps-5">
                        <input class="form-check-input" type="radio" name="dietaryRestrictions"
                          id="dietaryRestrictionsYes" value="yes">
                        <label class="form-check-label" for="dietaryRestrictionsYes">Yes</label>
                      </div>
                      <div class="form-check form-check-inline ps-5">
                        <input class="form-check-input" type="radio" name="dietaryRestrictions"
                          id="dietaryRestrictionsNo" value="no">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="form-group mt-2 ps-4">
                      <input type="text" class="form-control" name="otherDietary" placeholder="Other (please specify)">
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="vegan" id="vegan" name="vegan">
                      <label class="form-check-label" for="vegan">Vegan</label>
                    </div>
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="keto" id="keto" name="keto">
                      <label class="form-check-label" for="keto">Keto</label>
                    </div>
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="paleo" id="paleo" name="paleo">
                    ...
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="none" id="none" name="none">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div>
                      <div class="form-check form-check-inline ps-5">
                        <input class="form-check-input" type="radio" name="culturalRestrictions"
                          id="culturalRestrictionsYes" value="yes">
                        <label class="form-check-label" for="culturalRestrictionsYes">Yes</label>
                      </div>
                      <div class="form-check form-check-inline ps-5">
                        <input class="form-check-input" type="radio" name="culturalRestrictions"
                          id="culturalRestrictionsNo" value="no">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="halal" id="halal" name="halal">
                      <label class="form-check-label" for="halal">Halal</label>
                    </div>
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="kosher" id="kosher" name="kosher">
                    ...
                    <div class="form-check ps-5">
                      <input class="form-check-input" type="checkbox" value="hindu-dietary-laws" id="hinduDietaryLaws"
                        name="hinduDietaryLaws">
                      <label class="form-check-label" for="hinduDietaryLaws">Hindu dietary laws</label>
                    </div>
                    <div class="form-group mt-2 ps-4">
                      <input type="text" class="form-control" name="otherCultural" placeholder="Other (please specify)">
                    </div>
                  </div>

                  <button class="btn btn-primary w-100" name="preferenceBtn" type="submit">SUBMIT</button>
                </form>
    ...
    <ul class="second-nav">
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="../Login/signup.html">Register</a></li>
          <li><a href="../views/forgot_password.html">Forgot Password</a></li>
          <li><a href="../views/verification.html">Verification</a></li>
          <li><a href="../location/ocation.html">Location</a></li>
        </ul>
      </li>
      <li>
        <a href="../views/favorites.html"><i class="feather-heart me-2"></i> Favorites</a>
      </li>
      <li>
        <a href="../views/trending.html"><i class="feather-trending-up me-2"></i> Trending</a>
      </li>
      <li>
        <a href="most_popular.html"><i class="feather-award me-2"></i> Most Popular</a>
      </li>
      <li>
        <a href="../views/restaurant.html"><i class="feather-paperclip me-2"></i> Restaurant Detail</a>
      </li>
      <li>
        <a href="checkout.html"><i class="feather-list me-2"></i> Checkout</a>
      </li>
      <li>
        <a href="../views/successful.html"><i class="feather-check-circle me-2"></i> Successful</a>
      </li>
      <li>
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="../views/favorites.html">Delivery support</a></li>
          <li><a href="../views/contact-us.html">Contact Us</a></li>
          <li><a href="../views/terms.html">Terms of use</a></li>
      ...
      <li>
        ...
        <ul>
          <li><a href="../views/not-found.html">Not Found</a></li>
          <li><a href="../views/maintence.html"> Maintence</a></li>
          <li><a href="../views/coming-soon.html">Coming Soon</a></li>
        </ul>
      </li>
      <li>
            ...
            <div class="form-row">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-4 form-group">
                  <label class="form-label fw-bold small">CVV</label><input placeholder="Enter CVV Number" type="number"
                    class="form-control" />
                </div>
              </div>
              <div class="col-md-12 form-group mb-3">
                <label class="form-label fw-bold small">Name on card</label><input placeholder="Enter Card number"
            ...
            <div class="form-row">
              ...
              <div class="col-md-12 form-group mb-3">
                <label class="form-label">Delivery Instructions</label><input
                  placeholder="Delivery Instructions e.g. Opposite Gold Souk Mall" type="text" class="form-control" />
              </div>
  ...
  <script type="d925865b6df88847fb5af475-text/javascript" src="../vendor/jquery/jquery.min.js"></script>
  <script type="d925865b6df88847fb5af475-text/javascript" src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <script type="d925865b6df88847fb5af475-text/javascript" src="../vendor/slick/slick/slick.min.js"></script>

  <script type="d925865b6df88847fb5af475-text/javascript" src="../vendor/sidebar/hc-offcanvas-nav.js"></script>

  <script type="d925865b6df88847fb5af475-text/javascript" src="../js/osahan.js"></script>
  <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="d925865b6df88847fb5af475-|49" defer></script>
