...
<body class="fixed-bottom-bar">
        ...
        <div class="container">
            <div class="search py-5">
                <div class="input-group bg-white rounded-pill border mb-4">
                    <input type="text" class="form-control form-control-lg bg-transparent border-0 rounded-0"
                        id="inlineFormInputGroup" placeholder="Search">
                    <button class="btn bg-white text-primary bg-transparent border-0 rounded-0" type="button"><i
                            class="feather-search"></i></button>
                </div>

                <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active border-0 bg-light text-dark rounded" id="home-tab"
                            data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i
                                class="feather-home me-2"></i>Restaurants (8)</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link border-0 bg-light text-dark rounded ms-3" id="profile-tab"
                            data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                            aria-selected="false"><i class="feather-disc me-2"></i>Dishes (23)</a>
                    </li>
                </ul>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.html" class="text-black">The osahan
                                                        Restaurant
                                                    </a>
                                                </h6>
                                            ...
                                            <div class="list-card-badge">
                                                <span class="badge text-bg-danger">OFFER</span> <small>65%
                                                    OSAHAN50</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.html" class="text-black">Thai
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.html" class="text-black">Bite Me
                                                        Now Sandwiches</a></h6>
    ...
    <script type="162b4d2621d6b958e1dbd49e-text/javascript" src="../vendor/jquery/jquery.min.js"></script>
    <script type="162b4d2621d6b958e1dbd49e-text/javascript" src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <script type="162b4d2621d6b958e1dbd49e-text/javascript" src="../vendor/slick/slick/slick.min.js"></script>

    <script type="162b4d2621d6b958e1dbd49e-text/javascript" src="../vendor/sidebar/hc-offcanvas-nav.js"></script>

    <script type="162b4d2621d6b958e1dbd49e-text/javascript" src="../js/osahan.js"></script>
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="162b4d2621d6b958e1dbd49e-|49" defer></script>
    <script defer
        src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ=="
        data-cf-beacon='{"rayId":"8a5eb0b26d1c88c1","version":"2024.7.0","r":1,"serverTiming":{"name":{"cfL4":true}},"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}'
        crossorigin="anonymous"></script>
    <script src="../js/headerFooterManager.js"></script>
</body>

<!-- Mirrored from askbootstrap.com/preview/swiggiweb-v1-1/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jul 2024 00:04:09 GMT -->
