...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2024 at 10:44 AM
...
INSERT INTO `managercafeteria`(`userID`, `cafeteriaID`) VALUES
(3, 1),
(5, 2);
...
(1, 'user1@example.com', '123-456-7890', 'User One', 'Vegetarian', 'password1', 1, '', NULL),
(2, 'user2@example.com', '234-567-8901', 'User Two', 'Vegan', 'password2', 2, '', NULL),
(3, 'user3@example.com', '345-678-9012', 'User Three', 'Gluten-Free', 'password3', 4, '', NULL);
