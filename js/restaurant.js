...
function displayOrderDetails(orderInfo) {
  ...
  if (orderInfo) {
    ...
    const itemTotal = orderInfo.meals.reduce(
    ...
    orderHTML += `
            <div class="bg-white p-3 clearfix border-bottom">
                ...
                <hr />
                <h6 class="fw-bold mb-0">TO PAY <span class="float-end">GHS ${
                  itemTotal + 10
                }</span></h6>
            </div>
            <div class="p-3">
                <a class="btn btn-success w-100 btn-lg" href="successful.html">PAY GHS ${
                  itemTotal + 10
