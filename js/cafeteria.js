document.addEventListener('DOMContentLoaded', function () {
  ...
  function fetchMeals() {
    fetch('../actions/CafeteriaManagementService/get/fetchMeals.php')
      ...
      .then(data => {
        ...
        const currentMealCount = document.getElementById('currentMealCount');
        const archivedMealCount = document.getElementById('archivedMealCount');
  ...
  document.getElementById('addMealForm').addEventListener('submit', function (e) {
    ...
    const base64Image = localStorage.getItem('mealImage');

    if (base64Image) {
      formData.append('mealImage', base64Image);
    }
